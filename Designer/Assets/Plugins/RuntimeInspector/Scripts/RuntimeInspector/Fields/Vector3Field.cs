...
#pragma warning restore 0649
		...
		public void SetAdditionalEventForInputfields(BoundInputField.OnValueChangedDelegate unityEvent)
		{
			inputX.OnValueChanged += unityEvent;
			inputY.OnValueChanged += unityEvent;
			inputZ.OnValueChanged += unityEvent;
		}
		...
		public bool IsSameWithInputFieldX(BoundInputField input)
		{
			return input == inputX;
		}
		
		public bool IsSameWithInputFieldY(BoundInputField input)
		{
			return input == inputY;
		}
		
		public bool IsSameWithInputFieldZ(BoundInputField input)
		{
			return input == inputZ;
		}
