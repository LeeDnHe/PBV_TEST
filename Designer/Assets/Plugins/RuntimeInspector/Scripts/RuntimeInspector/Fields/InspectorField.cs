...
#pragma warning restore 0649
		...
		private List<string> visibleComponents = new List<string>(){"localPosition", "localEulerAngles", "localScale", "sharedMaterial"};

		public InspectorField CreateDrawerForVariable( MemberInfo variable, string variableName = null )
		{
			if (!visibleComponents.Contains(variable.Name)) return null;
